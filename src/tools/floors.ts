...
export function registerFloorTools(
  server: McpServer,
  ...
  server.registerTool(
    "io_list_floors",
    {
      ...
      inputSchema: z.object({
        ...
        buildingId: z
          .number()
          .describe("Filter floors by building ID")
          .optional(),
    ...
    async ({
      ...
      const path = buildingId
        ? `/buildings/${buildingId}/floors${qs}`
        : `/floors${qs}`;
    ...
    "io_create_floor",
    {
      ...
      inputSchema: z.object({
        ...
        totalSquareFootage: z
          .number()
          .describe("Total square footage of the floor")
          .optional(),
