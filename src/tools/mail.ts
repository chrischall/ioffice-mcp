  ...
  server.registerTool(
    "io_list_mail",
    {
      ...
      inputSchema: z.object({
        ...
        recipientId: z
          .number()
          .describe("Filter by recipient user ID")
          .optional(),
        startDate: z
          .string()
  ...
  server.registerTool(
    "io_create_mail",
    {
      ...
      inputSchema: z.object({
        ...
        carrier: z
          .string()
          .describe("Shipping carrier (e.g. UPS, FedEx, USPS)")
          .optional(),
        description: z
          .string()
          .describe("Description of the mail item")
          .optional(),
  ...
  server.registerTool(
    "io_deliver_mail",
    {
      ...
      inputSchema: z.object({
        ...
        signature: z
          .string()
          .describe("Recipient signature or name confirmation")
          .optional(),
        confirm: schemaConfirm,
      }),
      annotations: { readOnlyHint: false, destructiveHint: true },
    ...
    async ({ id, confirm, deliveredDate, signature }) => {
      const body = optionalBody({ deliveredDate, signature }, [
        "deliveredDate",
        "signature",
      ]);
      const gate = previewUnlessConfirmed(
