...
export function registerMoveTools(
  server: McpServer,
  ...
  server.registerTool(
    "io_list_moves",
    {
      ...
      inputSchema: z.object({
        ...
        startDate: z
          .string()
          .describe("Filter moves on or after this date (ISO 8601)")
          .optional(),
        endDate: z
          .string()
          .describe("Filter moves on or before this date (ISO 8601)")
          .optional(),
        limit: z
          .number()
  ...
  server.registerTool(
    "io_create_move",
    {
      ...
      inputSchema: z.object({
        ...
        scheduledDate: z
          .string()
          .describe("Scheduled move date (ISO 8601)")
          .optional(),
        buildingId: z
          .number()
