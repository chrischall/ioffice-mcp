...
describe('what compact does — and what it deliberately does not', () => {
  ...
  it('keeps EVERY other field, because nothing here knows which iOffice fields matter', () => {
  ...
  it('keeps a page URL', () => {
    const d = { link: 'https://tenant.iofficeconnect.com/reservations/9' };
