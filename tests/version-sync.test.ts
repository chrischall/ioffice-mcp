...
//
// This test catches it at CI time. The walk/assert logic now lives in
// `@chrischall/mcp-utils/test#versionSyncTest`; this file just points it
// at this repo's `src/` and `package.json`.
